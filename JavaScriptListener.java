...
public interface JavaScriptListener extends ParseTreeListener {
	...
	void enterPropertyReferenceSuffix(JavaScriptParser.PropertyReferenceSuffixContext ctx);
	void exitPropertyReferenceSuffix(JavaScriptParser.PropertyReferenceSuffixContext ctx);

	void enterInitialiserNoIn(JavaScriptParser.InitialiserNoInContext ctx);
	void exitInitialiserNoIn(JavaScriptParser.InitialiserNoInContext ctx);
	...
	void enterInitialiser(JavaScriptParser.InitialiserContext ctx);
	void exitInitialiser(JavaScriptParser.InitialiserContext ctx);
	...
	void enterForStatementInitialiserPart(JavaScriptParser.ForStatementInitialiserPartContext ctx);
	void exitForStatementInitialiserPart(JavaScriptParser.ForStatementInitialiserPartContext ctx);
	...
	void enterExpressionNoIn(JavaScriptParser.ExpressionNoInContext ctx);
	void exitExpressionNoIn(JavaScriptParser.ExpressionNoInContext ctx);
	...
	void enterMemberExpressionSuffix(JavaScriptParser.MemberExpressionSuffixContext ctx);
	void exitMemberExpressionSuffix(JavaScriptParser.MemberExpressionSuffixContext ctx);

	void enterCallExpressionSuffix(JavaScriptParser.CallExpressionSuffixContext ctx);
	void exitCallExpressionSuffix(JavaScriptParser.CallExpressionSuffixContext ctx);

	void enterRelationalExpressionNoIn(JavaScriptParser.RelationalExpressionNoInContext ctx);
	void exitRelationalExpressionNoIn(JavaScriptParser.RelationalExpressionNoInContext ctx);
	...
	void enterBitwiseANDExpressionNoIn(JavaScriptParser.BitwiseANDExpressionNoInContext ctx);
	void exitBitwiseANDExpressionNoIn(JavaScriptParser.BitwiseANDExpressionNoInContext ctx);
	...
	void enterVariableDeclarationNoIn(JavaScriptParser.VariableDeclarationNoInContext ctx);
	void exitVariableDeclarationNoIn(JavaScriptParser.VariableDeclarationNoInContext ctx);
	...
	void enterBitwiseORExpressionNoIn(JavaScriptParser.BitwiseORExpressionNoInContext ctx);
	void exitBitwiseORExpressionNoIn(JavaScriptParser.BitwiseORExpressionNoInContext ctx);

	void enterConditionalExpressionNoIn(JavaScriptParser.ConditionalExpressionNoInContext ctx);
	void exitConditionalExpressionNoIn(JavaScriptParser.ConditionalExpressionNoInContext ctx);
	...
	void enterLogicalANDExpressionNoIn(JavaScriptParser.LogicalANDExpressionNoInContext ctx);
	void exitLogicalANDExpressionNoIn(JavaScriptParser.LogicalANDExpressionNoInContext ctx);
	...
	void enterAssignmentExpressionNoIn(JavaScriptParser.AssignmentExpressionNoInContext ctx);
	void exitAssignmentExpressionNoIn(JavaScriptParser.AssignmentExpressionNoInContext ctx);
	...
	void enterStatementBlock(JavaScriptParser.StatementBlockContext ctx);
	void exitStatementBlock(JavaScriptParser.StatementBlockContext ctx);
	...
	void enterPropertyNameAndValue(JavaScriptParser.PropertyNameAndValueContext ctx);
	void exitPropertyNameAndValue(JavaScriptParser.PropertyNameAndValueContext ctx);

	void enterForInStatementInitialiserPart(JavaScriptParser.ForInStatementInitialiserPartContext ctx);
	void exitForInStatementInitialiserPart(JavaScriptParser.ForInStatementInitialiserPartContext ctx);
	...
	void enterIndexSuffix(JavaScriptParser.IndexSuffixContext ctx);
	void exitIndexSuffix(JavaScriptParser.IndexSuffixContext ctx);
	...
	void enterEqualityExpressionNoIn(JavaScriptParser.EqualityExpressionNoInContext ctx);
	void exitEqualityExpressionNoIn(JavaScriptParser.EqualityExpressionNoInContext ctx);
	...
	void enterLogicalORExpressionNoIn(JavaScriptParser.LogicalORExpressionNoInContext ctx);
	void exitLogicalORExpressionNoIn(JavaScriptParser.LogicalORExpressionNoInContext ctx);

	void enterVariableDeclarationListNoIn(JavaScriptParser.VariableDeclarationListNoInContext ctx);
	void exitVariableDeclarationListNoIn(JavaScriptParser.VariableDeclarationListNoInContext ctx);
	...
	void enterBitwiseXORExpressionNoIn(JavaScriptParser.BitwiseXORExpressionNoInContext ctx);
	void exitBitwiseXORExpressionNoIn(JavaScriptParser.BitwiseXORExpressionNoInContext ctx);
